...
## Team Mission 1
만화에서 소개된 내용 중에서는 태양열 발전 주택, 전기 자동차, 스마트폰, 전자신문, 무빙워크, 로봇 청소기, 인터넷 강의, 부엌의 모니터 등을 통해서 대부분의 것들이 실행된 것을 볼 수 있다. 
아직은 달나라 여행은 상용화까지는 달성하지 못했지만, 그 외 디른 기술들(수소 자동차, 소형 tv+전화기 등)은 현재 상용화 단계에 도달한 것을 볼 수 있다.
현재로부터 55년 전의 만화가가 현재와 거의 유사한 디지털 세상을 상상했다는게 놀랍고, 현재 이렇게 사람들이 살기 편한 세상이 왔다는 것에 감탄했다. 
이와 같이 우리도 지금부터 약 50년 후의 세상을 상상한다면 비슷하게 이 세상이 바뀔지도 궁금해졌다. 
## Team Mission 2
| **이름** | **전공** | **관심사** |
| --- | --- | --- |
| **박진우** | 소프트웨어전공 | 인공지능, 풀스택, 창업  |
