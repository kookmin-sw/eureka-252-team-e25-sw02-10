...
| **영상** | **실현된 기술** | 
| --- | --- | 
| **마이크로소프트** | 노트북의 경우는 상용화, 보딩패스와 카드와 같이 소형 디스플레이의 경우는 상용화| 
| ** - ** | 여러 국가의 언어를 실시간으로 번역해 주는 실시간 언어 번역 | 
| ** - ** | 컴퓨터를 사용하여 건물을 3차원으로 설계하고 시뮬레이션 하는 건축 및 3D 설계 소프트웨어  | 
| ** 코닝 ** | 멀리 떨어진 사람들과 화상으로 회의 및 대화하는 원격 회의 및 협업 도구  | 
| **ㄴㄴ** | ㄴ | 
